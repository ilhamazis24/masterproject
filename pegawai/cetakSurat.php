...
<body>
	...
	<div class="row">
		...
		<div class="header">
			...
			<span>Alamat : Pulau Pramuka, Kel. Pulau Panggang, Kec. Kepulauan Seribu Utara, Kab. Kepulauan Seribu, Daerah Khusus Ibukota Jakarta 14530
				<br/>Website : www.simpulseribu.id</span>
			</div>
		</div>
		<hr/>
		<div class="row">
			<div class="column-2">
				<p>Jakarta. 10 November 2020</p>
			</div>
			<br/>
			<div class="column">
				<table>
		...
		<div class="row">
			...
			<div class="column-isi">
				<p style="text-indent: 35px; text-align: justify;">Dengan ini saya mengajukan permintaan <?= $tipe_izin; ?> selama  <?= $lama_izin; ?> terhitung pada tanggal, <?= date('d F Y', strtotime($tanggal_awal)); ?> sampai dengan <?= date('d F Y', strtotime($tanggal_akhir)); ?>.</p>
				<p style="text-indent: 35px; text-align: justify;">Demikian surat permohonan cuti tahunan ini saya ajukan. Atas perhatian dan diberikannya permohonan izin ini, saya ucapkan banyak terima kasih</p>
			</div>
		</div>
		<br/>
		<div class="row">
			<div class="footer-2">
				...
				<br/>
				<br/>
				<p style="text-align: center;">( <?= $nama_lengkap; ?>) <br/>NIP : <?= $id_akun; ?></p>
			</div>
		</div>
