        ...
        <tbody>
          ...
          <td>
            ...
            <a href="" class="btn btn-danger btn-sm"><i class="fa fa-trash"></i></a>
             <?php
             $id = $d['id'];
              if ($status1 == "Di Terima") {
                echo "<a href='cetakSurat.php?id=$id' class='btn btn-success btn-sm'><i class='fa fa-print'></i></a>";
              }
              ?>
          </td>
        </tr>
        ...
        <form action="addPengajuan.php" method="POST" enctype="multipart/form-data">
          <div class="form-row">
            <div class="form-group col-md-4">
              ...
              <select id="inputState" class="form-control" name="tipe_izin">
            ...
            <div class="form-group col-md-8">
              ...
              <input type="text" name="lama_izin" class="form-control" id="izin" placeholder="3 hari / jam">
            </div>
          </div>
          <div class="form-row">
