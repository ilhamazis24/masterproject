...
?>
                                ...
                                <div class="col-lg-4">
                                    <nav class="breadcrumb-container" aria-label="breadcrumb">
                                        <ol class="breadcrumb">
                                            ...
                                            <li class="breadcrumb-item">
                                                <a href="data_pegawai.php">Tables</a>
                                            </li>
    ...
    while($d = mysqli_fetch_array($data)){
      ...
      <tr>
        ...
        <td><a href="edit_data_pegawai.php?id=<?php echo $d['id']; ?>" class="ik ik-edit f-16 mr-15 text-green"></a>
        <a href="hapus_data_pegawai.php?id=<?php echo $d['id']; ?>" class="ik ik-trash-2 f-16 text-red"></i></a></td>
        </tr>
      <?php 
    }
    ?>
